...
![ping](/img/VM1sshF.png){: style="height:40px;width:700px"}
...
![ping](/img/pcap/VM1pcap.png){: style="height:150px;width:800px"}

VM1 is able to access the web server using the public IP of the firewall.

- VM2 interface 1

![ping](/img/pcap/VM21pcap.png){: style="height:150px;width:800px"}

VM2 on interface 1 is able to see the traffic coming from and going to the client.

- VM2 interface 2

![ping](/img/pcap/VM22pcap.png){: style="height:150px;width:800px"}
...
![ping](/img/pcap/VM3pcap.png){: style="height:150px;width:800px"}
