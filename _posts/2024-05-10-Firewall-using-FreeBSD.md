...
```
![ping](assets/img-Firewall-using-FreeBSD/VM1setup.png){: style="height:300px;width:700px"}
...
```
![ping](assets/img-Firewall-using-FreeBSD/VM2setup.png){: style="height:300px;width:700px"}
...
```
![ping](assets/img-Firewall-using-FreeBSD/VM3setup.png){: style="height:300px;width:700px"}
...
ping 10.8.0.2
```
![ping](assets/img-Firewall-using-FreeBSD/VM1ping.png){: style="height:300px;width:700px"} <br>
We can also see the trace of the ping command from VM1 to VM3 using the following command:
```bash
traceroute 10.8.1.1
```
![ping](assets/img-Firewall-using-FreeBSD/VM1trace.png){: style="height:100px;width:700px"}
...
ping 10.8.1.1
```
![ping](assets/img-Firewall-using-FreeBSD/VM2ping.png){: style="height:300px;width:700px"}
...
ping 10.8.1.2
```
![ping](assets/img-Firewall-using-FreeBSD/VM3ping.png){: style="height:300px;width:700px"}
...
![ping](assets/img-Firewall-using-FreeBSD/VM2pfTable.png){: style="height:100px;width:700px"}
...
<!-- ![ping](assets/img-Firewall-using-FreeBSD/VM3server.png){: style="height:250px;width:900px"} -->
...
![ping](assets/img-Firewall-using-FreeBSD/VM1web.png){: style="height:170px;width:900px"}
...
![ping](assets/img-Firewall-using-FreeBSD/VM1sshW.png){: style="height:120px;width:700px"}

Above screen shot was taken prior to the configuration of the firewall.
<br>

![ping](assets/img-Firewall-using-FreeBSD/VM1sshF.png){: style="height:40px;width:700px"}
...
![ping](assets/img-Firewall-using-FreeBSD/pcap/VM1pcap.png){: style="height:150px;width:800px"}

VM1 is able to access the web server using the public IP of the firewall.

- VM2 interface 1

![ping](assets/img-Firewall-using-FreeBSD/pcap/VM21pcap.png){: style="height:150px;width:800px"}

VM2 on interface 1 is able to see the traffic coming from and going to the client.

- VM2 interface 2

![ping](assets/img-Firewall-using-FreeBSD/pcap/VM22pcap.png){: style="height:150px;width:800px"}
...
![ping](assets/img-Firewall-using-FreeBSD/pcap/VM3pcap.png){: style="height:150px;width:800px"}
